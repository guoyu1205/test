<template>
  ...
  <el-row :gutter="2">
    ...
    <el-col :span="16">
      ...
      <el-input v-model="input2" style="width: 140px;margin-left:20px" placeholder="学生" />
  ...
  <div class="table-container">
    ...
    >
      ...
      <el-table-column prop="phoneNumber" label="联系电话" align="center" min-width="130" />
      <el-table-column prop="category" label="实验所属学院" align="center" min-width="80" />
      <el-table-column prop="basicClass" label="学科" align="center" min-width="80" />
      <el-table-column prop="projectName" label="实验名称" align="center" min-width="80" />
      <el-table-column prop="detailNumber" label="实验室" align="center" min-width="160" />
...
const getFileInfo = async () => {
  ...
  let result1 = await abListService();
...
const exportConfig = computed(() => ({
  ...
  columns: [
    ...
    { label: '学生', prop: 'name', width: 15 },
    { label: '联系电话',prop: 'phoneNumber',width:20},
    { label: '实验所属学院', prop: 'category', width: 23 },
    { label: '学科', prop: 'basicClass', width: 20 },
    { label: '实验名称', prop: 'projectName', width: 20 },
    // { label: '标准名称', prop: 'standardName', width: 20 },
    { label: '实验室', prop: 'detailNumber', width: 20 },
    // { label: '通过时间', prop: 'times', width: 15 },
    { label: '准入试卷链接', prop: 'url1', width: 40 },
    { label: '考核视频链接', prop: 'url2', width: 40 },
