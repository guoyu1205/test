...
const isEmptySample = async() => {
  if (
    ...
    let params = {
      standardId: infoStore.info.standardId,
      productName: formAddSample.productName,
      specificationModel:formAddSample.specificationModel,
      manufacturer:formAddSample.manufacturer,
      batchNumber:formAddSample.batchNumber,
    };
    let result = await sampleAddService(params);
    sampleList();
...
<template>
  ...
  <div style="margin-top:20px;margin-left:500px;">
    <el-button plain @click="dialogFormAddSampleVisible = true" type="primary">+ 新增产品</el-button>
    <el-button type="primary" @click="reback">返回</el-button>
  </div>
  <!-- 弹出新增项目表单 -->
  <el-dialog v-model="dialogFormAddSampleVisible" title="新增项目" width="500">
    <el-form :model="formAddSample">
      <el-form-item label="产品名称：" :label-width="formLabelWidth" :required="true">
        <el-input v-model="formAddSample.productName" autocomplete="off" />
      </el-form-item>
      <el-form-item label="规格型号：" :label-width="formLabelWidth" :required="true">
        <el-input v-model="formAddSample.specificationModel" required autocomplete="off" />
      </el-form-item>
      <el-form-item label="生产厂家：" :label-width="formLabelWidth" :required="true">
        <el-input v-model="formAddSample.manufacturer" required autocomplete="off" />
      </el-form-item>
      <el-form-item label="批号：" :label-width="formLabelWidth" :required="true">
        <el-input v-model="formAddSample.batchNumber" required autocomplete="off" />
      </el-form-item>
    </el-form>
    <template #footer>
      <div class="dialog-footer">
        <el-button @click="cancel">取消</el-button>
        <el-button type="primary" @click="isEmptySample">提交</el-button>
      </div>
    </template>
  </el-dialog>

  <!-- 弹出修改项目表单 -->
  <el-dialog v-model="dialogFormEditSampleVisible" title="修改项目" width="500">
    <el-form :model="formEditSample">
      <el-form-item label="产品名称：" :label-width="formLabelWidth" :required="true">
        <el-input v-model="formEditSample.productName" autocomplete="off" />
      </el-form-item>
      <el-form-item label="规格型号：" :label-width="formLabelWidth" :required="true">
        <el-input v-model="formEditSample.specificationModel" required autocomplete="off" />
      </el-form-item>
      <el-form-item label="生产厂家：" :label-width="formLabelWidth" :required="true">
        <el-input v-model="formEditSample.manufacturer" required autocomplete="off" />
      </el-form-item>
      <el-form-item label="批号：" :label-width="formLabelWidth" :required="true">
        <el-input v-model="formEditSample.batchNumber" required autocomplete="off" />
      </el-form-item>
    </el-form>
    <template #footer>
      <div class="dialog-footer">
